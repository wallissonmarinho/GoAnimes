...
type CatalogRepository interface {
	...
	UpdateEpisodeDetails(ctx context.Context, tmdbID, season, episode int, airDate, title, overview, stillPath string) error
	GetByTMDBSeason(ctx context.Context, tmdbID, season int) (domain.Anime, bool, error)
	ListByTMDBID(ctx context.Context, tmdbID int) ([]domain.Anime, error)
